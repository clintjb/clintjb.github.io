...
Currently, the cost of running large AI models is being heavily subsidized by speculative capital (AI bubble anyone?) Eventually, the real economics will come into focus. When that happens, leadership will (quite rightly) ask for a hard business case. The questions will be simple - Did AI increase profit or free cash flow? Did it allow us to significantly reduce the number of people required to perform value adding tasks? Did it allow us to change the structure of the business?
